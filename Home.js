     ...
     <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
          <div class="resume-section-content">
            <h1 class="mb-0">
             syed
              <span class="text-primary">dastar</span>
            </h1>
            <div class="subheading mb-5">
              I am from Lahore pakistan (+92) 3011052123 ·
              <a href="mailto:name@email.com">F2020266@gemail.com</a>
            </div>
            <p class="lead mb-5">
        ...
        <section class="resume-section" id="education">
          <div class="resume-section-content">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div class="flex-grow-1">
                <h3 class="mb-0">University of Managment and technology</h3>
                <div class="subheading mb-3">BSCS</div>
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between">
              <div class="flex-grow-1">
                <h3 class="mb-0"> Kips college Multan pakistan</h3>
                <div class="subheading mb-3">Computer Science.</div>
                <p>Marks: 834 </p>
              </div>
              <div class="flex-shrink-0">
                <span class="text-primary">August 2017 - May 2019</span>
              </div>
            </div>
          </div>
        </section>
